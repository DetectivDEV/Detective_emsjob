...
function putOnStretcher(toggle, target)
    ...
    print(data.target)
    TriggerServerEvent("detective_emsjob:putOnStretcher", data)
    patientOnStretcher = toggle and target or nil
end

RegisterNetEvent("detective_emsjob:togglePatientFromVehicle", function(veh)
    local playerPed = cache.ped or PlayerPedId()
...
RegisterNetEvent("detective_emsjob:putOnStretcher", function(toggle)
    local playerPed = cache.ped or PlayerPedId()
    local playerCoords = cache.coords or GetEntityCoords(playerPed)
...
local function vehicleInteractions()
    local options = {
        {
            name = 'detective_emsjob_take_stretcher',
        ...
        {
            name = 'detective_emsjob_put_stretcher',
            icon = 'fa-solid fa-car-side',
        ...
        {
            name = 'detective_emsjob_put_patient_in_vehicle',
            icon = 'fa-solid fa-car-side',
            ...
            fn = function(data)
                ...
                TriggerServerEvent('detective_emsjob:togglePatientFromVehicle', dataToSend)
        ...
        {
            name = 'detective_emsjob_take_patient_from_vehicle',
            icon = 'fa-solid fa-car-side',
...
local function stretcherInteraction()
    addModel({ `prop_ld_binbag_01` }, {
        {
            name = 'detective_emsjob_stretcher_model',
            label = locale('take_stretcher'),
        ...
        {
            name = 'detective_emsjob_remove_from_stretcher',
            icon = 'fa-solid fa-car-side',
